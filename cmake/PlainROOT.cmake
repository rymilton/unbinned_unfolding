if(${ROOT_FOUND})
  message(STATUS "Setup using plain ROOT")
  ...
  install( FILES ${RooUnfoldHeadersOnly} DESTINATION include/
        COMPONENT headers)

  install( FILES ${TUnfoldHeaders} DESTINATION include/RooUnfold/TUnfold
        COMPONENT headers)
