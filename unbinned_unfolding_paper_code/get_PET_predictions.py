...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str, default="/global/homes/r/rmilton/m3246/rmilton/omnifold_paper_plots/unfolding/final_weights", help="Folder to store model weights")
...
def main():
    ...
    model.load_weights(flags.save_dir + "OmniFold_PET_02_2025_iter4_step2.weights.h5")
