...
<p>The unfolding method can either use the constructors for individual unfolding algorithms or the New() method,
specifiying the algorithm to be used. <p>The resultant distribution can be displayed as a plot (Hunfold) or as a bin by
bin breakdown of the true, measured and unfolded values (PrintTable) <p>A covariance matrix can be returned using the
Eunfold() method. A vector of its diagonals can be returned with the EunfoldV() method. <p>A summary of the unfolding
algorithms which inherit from this class is below: <ul> <li>RooUnfoldBayes: Uses the Bayes method of unfolding based on
the method written by D'Agostini (<a href="http://www.slac.stanford.edu/spires/find/hep/www?j=NUIMA,A362,487">NIM A 362
(1995) 487</a>). <ul> <li>Works for 1 & 2 dimensional distributions <li>Returned errors can be either as a diagonal
matrix or as a full matrix of covariances <li>Regularisation parameter sets the number of iterations used in the
unfolding (default=4) <li>Is able to account for bin migration and smearing <li>Can unfold if test and measured
distributions have different binning. <li>Returns covariance matrices with conditions approximately that of the machine
precision. This occasionally leads to very large chi squared values
</ul>
<li> RooUnfoldSVD: Uses the singular value decomposition method of Hocker and Kartvelishvili (<a
href="http://arxiv.org/abs/hep-ph/9509307">NIM A 372 (1996) 469</a>) <ul> <li>Regularisation parameter defines the level
at which values are deemed to be due to statistical fluctuations and are cut out. (Default= number of bins/2)
<li>Returns errors as a full matrix of covariances
<li>Error processing is much the same as with the kCovToy setting with 1000 toys. This is quite slow but can be switched
off. <li>Can only handle 1 dimensional distributions <li>True and measured distributions must have the same binning
...
<li> RooUnfoldIds: Uses the Bayes method of unfolding based on the method written by Malaescu (<a
href="http://arxiv.org/abs/1106.3107">CERN-PH-EP-2011-111</a>) <ul> <li>Set the number of iterations used to improve the
folding matrix <li>Regularisation parameters define the level at which values are deemed to be due to statistical
fluctuations. Used for modifying the folding matrix, as well as unfolding. <li>Returns errors as a full matrix of
covariances <li>Error processing is much the same as with the kCovToy setting with 1000 toys. This is quite slow but can
be switched off. <li>Can handle 2 dimensional distributions <li>True and measured distributions must have the same
binning <li>Can account for both smearing and biasing
</ul>
...
<li> RooUnfoldTUnfold: Uses the unfolding method implemented in ROOT's <a
href="http://root.cern.ch/root/html/TUnfold.html">TUnfold</a> class <ul> <li>Only included in ROOT versions 5.22 and
higher <li>Only able to unfold 1 dimensional distributions <li>Can account for bin migration and smearing <li>Errors
come as a full covariance matrix. <li>Will sometimes warn of "unlinked" bins. These are bins with 0 entries and do not
effect the results of the unfolding <li>Regularisation parameter can be either optimised internally by plotting
log10(chi2 squared) against log10(tau). The 'kink' in this curve is deemed the optimum tau value. This value can also be
set manually (FixTau) <li>The latest version (TUnfold v15) requires that RooUnfoldResponse::SetOverflow=0. ROOT
versions 5.26 or below use v13 and so should be safe to use overflows
</ul>
...
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kNone = RooUnfolding::kNone;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kBayes = RooUnfolding::kBayes;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kSVD = RooUnfolding::kSVD;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kBinByBin = RooUnfolding::kBinByBin;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kTUnfold = RooUnfolding::kTUnfold;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kInvert = RooUnfolding::kInvert;
// template<class Hist,class Hist2D> const typename RooUnfoldT<Hist,Hist2D>::Algorithm
// RooUnfoldT<Hist,Hist2D>::kDagostini = RooUnfolding::kDagostini;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kIDS = RooUnfolding::kIDS;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kGP = RooUnfolding::kGP;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::Algorithm RooUnfoldT<Hist, Hist2D>::kPoisson = RooUnfolding::kPoisson;
template<class Hist,class Hist2D> 
const typename RooUnfoldT<Hist,Hist2D>::Algorithm RooUnfoldT<Hist,Hist2D>::kOmnifold = RooUnfolding::kOmnifold;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kNoError = RooUnfolding::kNoError;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kErrors = RooUnfolding::kErrors;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kCovariance =
   RooUnfolding::kCovariance;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kErrorsToys =
   RooUnfolding::kErrorsToys;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kCovToys = RooUnfolding::kCovToys;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::ErrorTreatment RooUnfoldT<Hist, Hist2D>::kDefault = RooUnfolding::kDefault;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::BiasError RooUnfoldT<Hist, Hist2D>::kBiasSD = RooUnfolding::kBiasSD;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::BiasError RooUnfoldT<Hist, Hist2D>::kBiasSDM = RooUnfolding::kBiasSDM;
template <class Hist, class Hist2D>
const typename RooUnfoldT<Hist, Hist2D>::BiasError RooUnfoldT<Hist, Hist2D>::kBiasRMS = RooUnfolding::kBiasRMS;

using namespace RooUnfolding;

template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D>::RooUnfoldT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas, const char *name,
                                     const char *title)
   : TNamed(name, title)
{
...
RooUnfoldT<Hist, Hist2D>::New(RooUnfolding::Algorithm alg, const RooUnfoldResponseT<Hist, Hist2D> *res,
                              const Hist *meas, Double_t regparm, const char *name, const char *title)
{
   ...
   */
   ...
   case kNone: unfold = new RooUnfoldT<Hist, Hist2D>(res, meas); break;

   case kBayes: unfold = new RooUnfoldBayesT<Hist, Hist2D>(res, meas); break;

   case kSVD: unfold = new RooUnfoldSvdT<Hist, Hist2D>(res, meas); break;

   case kBinByBin: unfold = new RooUnfoldBinByBinT<Hist, Hist2D>(res, meas); break;
   ...
   case kInvert: unfold = new RooUnfoldInvertT<Hist, Hist2D>(res, meas); break;
   case kGP: unfold = new RooUnfoldGPT<Hist, Hist2D>(res, meas); break;
   case kPoisson: unfold = new RooUnfoldPoissonT<Hist, Hist2D>(res, meas); break;
   case kOmnifold: unfold = new RooUnfoldOmnifoldT<Hist, Hist2D> (res, meas); break;
   /*
   case kDagostini:
     cerr << "RooUnfoldDagostini is not available" << endl;
     return 0;
   */
   case kIDS: unfold = new RooUnfoldIdsT<Hist, Hist2D>(res, meas); break;

   default: throw std::runtime_error(TString::Format("Unknown RooUnfold method %d", (int)alg).Data());
   }

   if (name)
      unfold->SetName(name);
   if (title)
      unfold->SetTitle(title);
   if (regparm != -1e30) {
...
template <class Hist, class Hist2D>
typename RooUnfoldT<Hist, Hist2D>::Cache &
RooUnfoldT<Hist, Hist2D>::Cache::operator=(const RooUnfoldT<Hist, Hist2D>::Cache &other)
{
   //! assignment operator
...
template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D>::RooUnfoldT(const RooUnfoldT<Hist, Hist2D> &rhs) : TNamed(rhs.GetName(), rhs.GetTitle())
{
   //! Copy constructor.
   Init();
   CopyData(rhs);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Assign(const RooUnfoldT<Hist, Hist2D> &rhs)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::CopyData(const RooUnfoldT<Hist, Hist2D> &rhs)
{
...
template <class Hist, class Hist2D>
RooUnfolding::Algorithm RooUnfoldT<Hist, Hist2D>::GetAlgorithm() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Reset()
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Init()
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::ResetUnfold()
{
   _cache = Cache();
}

template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D> &RooUnfoldT<Hist, Hist2D>::Setup(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetMeasured(const Hist *meas)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetMeasured(const TVectorD &meas, const TVectorD & /*err*/)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetTruth(const Hist *truth)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetTruth(const TVectorD &truth, const TVectorD & /*err*/)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetBkg(const Hist *bkg)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetBkg(const TVectorD &bkg, const TVectorD & /*err*/)
{
   //! Set truth distribution and errors. Should be called after setting response matrix.
   const Hist *orig = _res->Htruth();
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetMeasured(const TVectorD &meas, const TMatrixD &cov)
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetMeasuredCov(const TMatrixD &cov)
{
...
template <class Hist, class Hist2D>
const TMatrixD &RooUnfoldT<Hist, Hist2D>::GetMeasuredCov() const
{
...
template <class Hist, class Hist2D>
const TVectorD RooUnfoldT<Hist, Hist2D>::Pull(Int_t BinN) const
{
   if (!_cache._havePull) {
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::ForceRecalculation() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetResponse(const RooUnfoldResponseT<Hist, Hist2D> *res, Bool_t takeOwnership)
{
   //! Set response matrix for unfolding, optionally taking ownership of the RooUnfoldResponseT<Hist,Hist2D> object
   if (!res)
      throw std::runtime_error("cannot set response to invalid value!");
   if (takeOwnership)
      _res = const_cast<RooUnfoldResponseT<Hist, Hist2D> *>(res);
   else
      _res = new RooUnfoldResponseT<Hist, Hist2D>(*res);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Unfold() const
{
   //! Dummy unfolding - just copies input
   cout << "********************** " << ClassName() << ": dummy unfolding - just copy input **********************"
        << endl;

   int nm = response()->Vmeasured().GetNrows();
   int nt = response()->Vtruth().GetNrows();

   _cache._rec.ResizeTo(nt);
   Int_t nb = nm < nt ? nm : nt;
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetErrors() const
{
   int nt = response()->Vtruth().GetNrows();

   this->GetCov();
   _cache._variances.ResizeTo(nt);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetCov() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetWgt() const
{
   ...
   if (!_cache._haveCov)
      return;
   if (!InvertMatrix(_cache._cov, _cache._wgt, "covariance matrix", _verbose))
      return;
   _cache._haveWgt = true;
}

template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetErrMat() const
{
   //! Get covariance matrix from the variation of the results in toy MC tests
   int nt = response()->Vtruth().GetNrows();
   if (_NToys <= 1)
      return;
   _cache._err_mat.ResizeTo(nt, nt);
   TVectorD xisum(nt);
   TMatrixD xijsum(nt, nt);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::CalculateBias(Int_t ntoys, const Hist *hTrue) const
{
   ...
   _cache._bias.ResizeTo(nt);
   _cache._sdbias.ResizeTo(nt);
   _cache._sdmbias.ResizeTo(nt);
   _cache._rmsbias.ResizeTo(nt);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::CalculatePull(Int_t ntoys, const Hist *hTrue) const
{
   Bool_t haveerrors = this->_cache._haveErrors;
   Bool_t havecov = this->_cache._haveCov;
   ...
   Hist *asimov = RooUnfolding::asimov1DClone(this->response()->Hmeasured(), this->response()->UseDensityStatus(),
                                              vreco2, vrecoerr);
   auto *toyFactory = this->New(this->GetAlgorithm(), this->response(), asimov, GetRegParm());
   if (!toyFactory) {
      throw std::runtime_error(
         TString::Format("unable to instantiate toy factory with algorithm '%d'", this->GetAlgorithm()).Data());
   }
   ...
   _cache._AvgPull.ResizeTo(nt);
   _cache._pull.ResizeTo(ntoys, nt);
...
template <class Hist, class Hist2D>
Bool_t RooUnfoldT<Hist, Hist2D>::UnfoldWithErrors(ErrorTreatment withError, bool getWeights) const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldT<Hist, Hist2D>::Chi2(const Hist *hTrue, ErrorTreatment DoChi2) const
{
   ...
   int nt = response()->Vtruth().GetNrows();
   if (!UnfoldWithErrors(DoChi2))
      return -1.0;
   TVectorD vtrue = h2v(hTrue, this->Overflow(), this->response()->UseDensityStatus());
   TVectorD res = _cache._rec - vtrue;
   Double_t chi2 = 0.0;
   if (DoChi2 == kCovariance || DoChi2 == kCovToys) {
      TMatrixD wgt(Wunfold(DoChi2));
      if (_cache._fail)
         return -1.0;
      TMatrixD resmat(1, nt), chi2mat(1, 1);
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::PrintTable(const Hist *hTrue, RooUnfolding::ErrorTreatment withError) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::PrintTable(std::ostream &o, const Hist *hTrue, ErrorTreatment withError) const
{
   //! Prints entries from truth, measured, and unfolded data for each bin.
   if (withError == kDefault)
      withError = _withError;
   if (withError == kDefault)
      withError = kErrors;
   if (!UnfoldWithErrors(withError))
      withError = kNoError;
   if (!hTrue) {
      hTrue = response()->Htruth();
   }

   auto eunfoldv = this->EunfoldV(withError);
   auto vunfold = this->Vunfold();

   int ntxb = nBins(_res->Htruth(), X, this->Overflow());
   int ntyb = nBins(_res->Htruth(), Y, this->Overflow());

   int d = dim(_res->Htruth());
   if (!_cache._unfolded)
      return;

   Double_t chi_squ = (hTrue && (withError == kCovariance || withError == kCovToys)) ? Chi2(hTrue, withError) : -999.;

   printTable(o, d, ntxb, ntyb, response()->Vtruth(), response()->Vmeasured(),
              hTrue ? h2v(hTrue, this->Overflow(), this->response()->UseDensityStatus()) : response()->Vtruth(),
              Vmeasured(), vunfold, withError,
              hTrue ? h2ve(hTrue, this->Overflow(), this->response()->UseDensityStatus()) : response()->Etruth(),
              eunfoldv, chi_squ);
}

template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::SetNameTitleDefault()
{
   if (!_res)
      return;
   const char *s = GetName();
   if (s[0] == '\0')
      SetName(_res->GetName());
   s = GetTitle();
   if (s[0] == '\0') {
...
template <class Hist, class Hist2D>
Hist *RooUnfoldT<Hist, Hist2D>::Hunfold(ErrorTreatment withError)
{
   ...
   */
   ...
   if (!_cache._unfolded) {
      ...
      Hist *unfolded = RooUnfolding::createHist<Hist, Hist>(rec, errors, "unfolded", GetTitle(), vars(_res->Htruth()),
                                                            this->Overflow());
      return unfolded;
   }
}
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetSettings() const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldT<Hist, Hist2D>::GetMinParm() const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldT<Hist, Hist2D>::GetMaxParm() const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldT<Hist, Hist2D>::GetStepSizeParm() const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldT<Hist, Hist2D>::GetDefaultParm() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Print(Option_t * /*opt*/) const
{
   ...
   if (_covMes)
      cout << "with measurement covariance, ";
   if (_dosys)
      cout << "calculate systematic errors, ";
   if (dim(_meas) == 1)
      cout << nm;
   else {
      cout << nBins(_meas, X, Overflow()) << "x" << nBins(_meas, Y, Overflow());
      if (dim(_meas) >= 3)
   ...
   if (dim(rtrue) == 1)
      ...
      cout << nBins(rtrue, X, Overflow()) << "x" << nBins(rtrue, Y, Overflow());
      if (dim(rtrue) >= 3)
         cout << "x" << nBins(rtrue, Z, Overflow());
      cout << " (" << nt << ")";
   }
   cout << " bins truth";
   if (Overflow())
      cout << " including overflows";
   cout << endl;
}

template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Dump() const
{
...
template <class Hist, class Hist2D>
TMatrixD RooUnfoldT<Hist, Hist2D>::CutZeros(const TMatrixD &ereco)
{
...
template <class Hist, class Hist2D>
TMatrixD RooUnfoldT<Hist, Hist2D>::Eunfold(ErrorTreatment withError) const
{
   ...
   */
   ...
   if (!UnfoldWithErrors(withError))
      return TMatrixD(nt, nt);

   switch (withError) {
   case kNoError: {
      TMatrixD Eunfold_m(nt, nt);
      for (int i = 0; i < nt; i++) {
   ...
   case kCovariance: return _cache._cov; break;
   case kCovToys: {
      return _cache._cov;
      break;
   }
   default:
      throw std::runtime_error(
         TString::Format("Error in RooUnfoldT::Wunfold, unrecognised error method '%d'", withError).Data());
   }
}

template <class Hist, class Hist2D>
TVectorD RooUnfoldT<Hist, Hist2D>::EunfoldV(ErrorTreatment withError) const
{
   ...
   */
   ...
   default:
      throw std::runtime_error(
         TString::Format("Error in RooUnfoldT::EunfoldV, unrecognised error method '%d'", withError).Data());
   }
...
template <class Hist, class Hist2D>
TMatrixD RooUnfoldT<Hist, Hist2D>::Wunfold(ErrorTreatment withError) const
{
   //! TODO: document
   int nt = response()->Vtruth().GetNrows();
   TMatrixD Wunfold_m(nt, nt);
   if (!UnfoldWithErrors(withError, true))
      return Wunfold_m;

   switch (withError) {
   case kNoError:
      for (int i = 0; i < nt; i++) {
         if (_cache._rec(i) != 0.0)
            Wunfold_m(i, i) = 1.0 / _cache._rec(i);
      }
      break;
   case kErrors:
   case kErrorsToys:
      ...
      break;
   case kCovariance: Wunfold_m = _cache._wgt; break;
   case kCovToys: InvertMatrix(_cache._err_mat, Wunfold_m, "covariance matrix from toys", _verbose); break;
   default:
      throw std::runtime_error(
         TString::Format("Error in RooUnfoldT::Wunfold, unrecognised error method '%d'", withError).Data());
   }
...
template <class Hist, class Hist2D>
TVectorD RooUnfoldT<Hist, Hist2D>::CoverageProbV(Int_t sigma) const
{
   ...
   for (int i = 0; i < coverage.GetNrows(); i++) {
      ...
      if (se(i)) {
         coverage(i) =
            ROOT::Math::normal_cdf(bias(i) / se(i) + sigma) - ROOT::Math::normal_cdf(bias(i) / se(i) - sigma);
      } else {
         coverage(i) = 0;
      }
   }
...
template <class Hist, class Hist2D>
TVectorD RooUnfoldT<Hist, Hist2D>::ScanCoverage(TVectorD &regparms, Int_t bin, Int_t sigma) const
{
...
//! One can also specify the confidence level(sigma).
template <class Hist, class Hist2D>
TVectorD RooUnfoldT<Hist, Hist2D>::ScanBias2Var(TVectorD &regparms, Int_t bin) const
{
...
template <class Hist, class Hist2D>
Int_t RooUnfoldT<Hist, Hist2D>::InvertMatrix(const TMatrixD &mat, TMatrixD &inv, const char *name, Int_t verbose)
{
   ...
   if (cond < 0.0) {
      ...
      cerr << "Warning: poorly conditioned " << name << " - inverse may be inaccurate (condition=" << cond << ")"
           << endl;
      ok = 3;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::Streamer(TBuffer &R__b)
{
...
template <>
void RooUnfoldT<TH1, TH2>::Streamer(TBuffer &R__b)
{
   //! Stream an object of class RooUnfold.
   if (R__b.IsReading()) {
...
template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D>::RooUnfoldT() : TNamed()
{
...
template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D>::RooUnfoldT(const char *name, const char *title) : TNamed(name, title)
{
...
template <class Hist, class Hist2D>
RooUnfoldT<Hist, Hist2D>::RooUnfoldT(const TString &name, const TString &title) : TNamed(name, title)
{
   //! Basic named constructor. Use Setup() to prepare for unfolding.
   Init();
}
...
const TVectorD &RooUnfoldT<Hist, Hist2D>::Vunfold() const
{
   ...
   if (!_cache._unfolded) {
      ...
      if (!_cache._unfolded) {
         _cache._fail = true;
         if (nt > 0 && _cache._rec.GetNrows() == 0)
            _cache._rec.ResizeTo(nt); // need something
      }
   }
...
const TVectorD &RooUnfoldT<Hist, Hist2D>::Vmeasured() const
{
   ...
   if (!_cache._vMes) {
      _cache._vMes = new TVectorD(h2v(_meas, Overflow(), this->response()->UseDensityStatus()));
   }
   return *_cache._vMes;
}
...
const TVectorD &RooUnfoldT<Hist, Hist2D>::Vtruth() const
{
   //! Measured distribution as a vector.
   if (!_cache._vTruth) {
      _cache._vTruth = new TVectorD(h2v(_truth, Overflow(), this->response()->UseDensityStatus()));
   }
...
const TVectorD &RooUnfoldT<Hist, Hist2D>::Vbkg() const
{
   //! Measured distribution as a vector.
   if (!_cache._vBkg) {
      _cache._vBkg = new TVectorD(h2v(_bkg, Overflow(), this->response()->UseDensityStatus()));
   }
   return *_cache._vBkg;
}
...
{
   //! AvgPull distribution as a vector
   if (!_cache._haveAvgPull) {
      throw std::runtime_error("calculate bias before attempting to retrieve it!");
   }
...
const TVectorD RooUnfoldT<Hist, Hist2D>::Ebias(RooUnfolding::BiasError E_type) const
{
   ...
   switch (E_type) {
   case kBiasSD: return _cache._sdbias;
   case kBiasSDM: return _cache._sdmbias;
   case kBiasRMS: return _cache._rmsbias;
   }
...
const TVectorD &RooUnfoldT<Hist, Hist2D>::Emeasured() const
{
   ...
   if (!_cache._eMes) {
      if (_covMes) {
         _cache._eMes = new TVectorD(nm);
         for (Int_t i = 0; i < nm; i++) {
            Double_t e = (*_covMes)(i, i);
            if (e > 0.0)
               (*_cache._eMes)[i] = sqrt(e);
         }
      } else {
...
#include "RooDataSet.h"
   template <>
   void RooUnfoldT<RooUnfolding::RooFitHist, RooUnfolding::RooFitHist>::SetResponse(
      const RooUnfoldResponseT<RooUnfolding::RooFitHist, RooUnfolding::RooFitHist> *res, Bool_t /*takeOwnership*/)
{
   //! Set response matrix for unfolding, optionally taking ownership of the RooUnfoldResponseT<Hist,Hist2D> object
   if (!res)
      throw std::runtime_error("cannot set response to invalid value!");
   ...
   if (hist) {
      ...
      for (RooAbsArg *p : *args) {
         ...
         if (rrv->isConstant())
            continue;
         if (rrv->getError() == 0.) {
            throw std::runtime_error(TString::Format("unable to build covariance matrix for parameter '%s' with error "
                                                     "0 - is this an observable? please set constant",
                                                     rrv->GetName())
                                        .Data());
         }
         std::string paramName(rrv->GetName());
         if (paramName.find(type) != 0 && type != "all")
            continue;
         params.add(*rrv);
      }
      delete args;
...
public:
   void setCovariance(TMatrixDSym &m) { this->setCovarianceMatrix(m); }
};
} // namespace
#endif

template <>
void RooUnfoldT<TH1, TH2>::RunRooFitToys(int ntoys, std::vector<TVectorD> &vx, std::vector<TVectorD> &vxe,
                                         std::vector<double> &chi2) const
{
...
#ifndef NOROOFIT
template <>
void RooUnfoldT<RooUnfolding::RooFitHist, RooUnfolding::RooFitHist>::RunRooFitToys(int ntoys, std::vector<TVectorD> &vx,
                                                                                   std::vector<TVectorD> &vxe,
                                                                                   std::vector<double> &chi2) const
{

   //! Create un unfolding instance with the reconstructed histogram
   //! set as the measured histogram.
   RooUnfolding::RooFitHist *asimov =
      RooUnfolding::asimovClone(this->response()->Hmeasured(), this->response()->UseDensityStatus());
   auto *toyFactory = this->New(this->GetAlgorithm(), this->response(), asimov, GetRegParm());
   if (!toyFactory) {
      throw std::runtime_error(
         TString::Format("unable to instantiate toy factory with algorithm '%d'", this->GetAlgorithm()).Data());
   ...
   switch (this->_dosys) {
   case kNoSystematics: this->RunToys(ntoys, vx, vxe, chi2); return;
   case kGammas: paramType = "gamma"; break;
   case kAlphas: paramType = "alpha"; break;
   case kAll:
   case kNoStatistics: paramType = "all"; break;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::RunToys(int ntoys, std::vector<TVectorD> &vx, std::vector<TVectorD> &vxe,
                                       std::vector<double> &chi2) const
{
...
template <class Hist, class Hist2D>
double RooUnfoldT<Hist, Hist2D>::RunToy(TVectorD &x, TVectorD &xe) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetErrorsToys() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetCovToys() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetSampleVar(std::vector<TVectorD> &munfolded) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldT<Hist, Hist2D>::GetSampleCov(std::vector<TVectorD> &munfolded) const
{
   //! Get covariance matrix from the variation of the results in toy MC tests
   int nt = response()->Vtruth().GetNrows();
   _cache._cov.ResizeTo(nt, nt);
