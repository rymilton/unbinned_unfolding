 ...
 *
 * Copyright © 2020–2025 CERN and the authors’ respective research institutions
...
template <class Hist, class Hist2D>
RooUnfoldPoissonT<Hist, Hist2D>::RooUnfoldPoissonT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas,
                                                   Double_t regparm, const char *name, const char *title)
...
template <class Hist, class Hist2D>
RooUnfolding::Algorithm RooUnfoldPoissonT<Hist, Hist2D>::GetAlgorithm() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::Init()
{
   GetSettings();
}

template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::Reset()
{
   Init();
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::Assign(const RooUnfoldPoissonT<Hist, Hist2D> &rhs)
{
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::CopyData(const RooUnfoldPoissonT<Hist, Hist2D> &rhs)
{
   this->_regparm = rhs._regparm;
}

template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::Unfold() const
{
   ...
   if (!(_min_status == 0) && this->_verbose) {
      std::cout << "Regularized negative log-likelihood did not converge. Check input and minimization settings."
                << std::endl;
      return;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::GetCov() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::GetSettings() const
{
...
//-------------------------------------------------------------------------
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::setup() const
{
   int nt = this->response()->Vtruth().GetNrows();
...
template <class Hist, class Hist2D>
double *RooUnfoldPoissonT<Hist, Hist2D>::Rmu(const double *truth) const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldPoissonT<Hist, Hist2D>::NegativeLLH(const double *truth) const
{
...
//! bin widths.
template <class Hist, class Hist2D>
Double_t RooUnfoldPoissonT<Hist, Hist2D>::TikhonovReg(const double *truth) const
{
   ...
   for (int i = i_start; i < _response.GetNcols() - 2 - i_start; i++) {
      ...
      Double_t sec_der = ((truth[i + 2] / binwidth3 - truth[i + 1] / binwidth2) / d32 -
                          (truth[i + 1] / binwidth2 - truth[i] / binwidth1) / d21) /
                         ((d32 + d21));
...
template <class Hist, class Hist2D>
Double_t RooUnfoldPoissonT<Hist, Hist2D>::RegLLH(const double *truth) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldPoissonT<Hist, Hist2D>::MinimizeRegLLH() const
{
   int nt = this->response()->Vtruth().GetNrows();
...
template <class Hist, class Hist2D>
RooUnfoldPoissonT<Hist, Hist2D>::RooUnfoldPoissonT() : RooUnfoldT<Hist, Hist2D>()
{
...
template <class Hist, class Hist2D>
RooUnfoldPoissonT<Hist, Hist2D> &RooUnfoldPoissonT<Hist, Hist2D>::operator=(const RooUnfoldPoissonT<Hist, Hist2D> &rhs)
{
