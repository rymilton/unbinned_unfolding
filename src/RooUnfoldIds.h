...
public:
   ...
   RooUnfoldIdsT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas, Int_t niter = 1, const char *name = 0,
                 const char *title = 0);
...
private:
   ...
   TVectorD *GetIDSUnfoldedSpectrum(TVectorD h_RecoMC, TVectorD h_TruthMC, TMatrixD h_2DSmear, TVectorD h_RecoData,
                                    TVectorD h_RecoDataError, Int_t iter) const;
   Double_t Probability(Double_t deviation, Double_t sigma, Double_t lambda) const;
   Double_t MCnormalizationCoeff(const TVectorD *vd, const TVectorD *errvd, const TVectorD *vRecmc, const Int_t dim,
                                 const Double_t estNknownd, const Double_t Nmc, const Double_t lambda,
                                 const TVectorD *soustr_) const;
   Double_t MCnormalizationCoeffIter(const TVectorD *vd, const TVectorD *errvd, const TVectorD *vRecmc, const Int_t dim,
                                     const Double_t estNknownd, const Double_t Nmc, const TVectorD *soustr_,
                                     Double_t lambdaN = 0., Int_t NiterMax = 5, Int_t messAct = 1) const;
   void IdsUnfold(const TVectorD &b, const TVectorD &errb, const TMatrixD &A, const Int_t dim, const Double_t lambda,
                  TVectorD *soustr_, TVectorD *unf) const;
   void ComputeSoustrTrue(const TMatrixD *A, const TVectorD *unfres, const TVectorD *unfresErr, Int_t N,
                          TVectorD *soustr_, Double_t lambdaS) const;
   void ModifyMatrix(TMatrixD *Am, const TMatrixD *A, const TVectorD *unfres, const TVectorD *unfresErr, Int_t N,
                     const Double_t lambdaM_, TVectorD *soustr_, const Double_t lambdaS_) const;
   void PerformIterations(const TVectorD &data, const TVectorD &dataErr, const TMatrixD &A_, const Int_t &N_,
                          Double_t lambdaL_, Int_t NstepsOptMin_, Double_t lambdaU_, Double_t lambdaM_,
                          Double_t lambdaS_, TVectorD *unfres1IDS_, TVectorD *unfres2IDS_) const;
