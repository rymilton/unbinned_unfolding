...
RooUnfoldGPT<Hist, Hist2D>::RooUnfoldGPT() : RooUnfoldT<Hist, Hist2D>()
{
...
template <class Hist, class Hist2D>
RooUnfoldGPT<Hist, Hist2D>::RooUnfoldGPT(const char *name, const char *title) : RooUnfoldT<Hist, Hist2D>(name, title)
{
...
template <class Hist, class Hist2D>
RooUnfolding::Algorithm RooUnfoldGPT<Hist, Hist2D>::GetAlgorithm() const
{
...
template <class Hist, class Hist2D>
RooUnfoldGPT<Hist, Hist2D>::RooUnfoldGPT(const RooUnfoldGPT<Hist, Hist2D> &rhs) : RooUnfoldT<Hist, Hist2D>(rhs)
{
   //! Copy constructor.
   Init();
}
...
template <class Hist, class Hist2D>
RooUnfoldGPT<Hist, Hist2D>::RooUnfoldGPT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas, Int_t kernel,
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::Init()
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::Reset()
{
...
template <class Hist, class Hist2D>
TDecompSVD *RooUnfoldGPT<Hist, Hist2D>::Impl()
{
   return _specialcache._svd;
}

template <class Hist, class Hist2D>
Double_t RooUnfoldGPT<Hist, Hist2D>::GetRegParm() const
{
   return (Double_t)_kernel;
}
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::SetRegParm(Double_t regparm)
{
   _kernel = regparm;
}

template <class Hist, class Hist2D>
Bool_t RooUnfoldGPT<Hist, Hist2D>::checkGP(const TVectorD &hist) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::SetBinCenters() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::SetFitSettings() const
{

   if (_kernel == 1) {
      if (_specialcache._kernel_init.size() == 2)
         return;
      ...
      if (_specialcache._kernel_init.size() == 3)
         return;
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::Unfold() const
{
   int nt = this->response()->Vtruth().GetNrows();
   int nm = this->response()->Vmeasured().GetNrows();

   if (_kernel == 2) {
      std::cout << "ERROR: The Gibbs kernel is not fully implemented yet. Please use the radial kernel for now."
                << std::endl;
      return;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::GetCov() const
{
   MAPCovariance();
   int nt = this->response()->Vtruth().GetNrows();
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::MLEstimator() const
{
   ...
   if (!checkGP(_specialcache._MLEst) && this->_verbose) {
      std::cout << "WARNING! Some of the bin counts are very low. The Gaussian bin count assumption might not hold "
                   "resulting in bad unfolding results"
                << std::endl;
   }
   ...
   if (nt > nm) {
      ok = InvertResponse();
      if (ok)
         _specialcache._MLEst *= *_specialcache._resinv;
   } else
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::MLCovariance() const
{
   int nt = this->response()->Vtruth().GetNrows();
   int nm = this->response()->Vmeasured().GetNrows();
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::MAPEstimator() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::MAPCovariance() const
{
   int nt = this->response()->Vtruth().GetNrows();
...
template <class Hist, class Hist2D>
Bool_t RooUnfoldGPT<Hist, Hist2D>::InvertResponse() const
{
   int nm = this->response()->Vmeasured().GetNrows();
   int nt = this->response()->Vtruth().GetNrows();

   if (!_specialcache._svd)
      return false;
   if (_specialcache._resinv)
      return true;
   if (nt > nm)
      _specialcache._resinv = new TMatrixD(nm, nt);
   else
      _specialcache._resinv = new TMatrixD(nt, nm);
...
#endif
   if (nt > nm)
      _specialcache._resinv->T();
   return true;
}

template <class Hist, class Hist2D>
TVectorD RooUnfoldGPT<Hist, Hist2D>::MultiplyMatrixVector(const TMatrixD &matrix, const TVectorD &vector) const
{
...
template <class Hist, class Hist2D>
TVectorD RooUnfoldGPT<Hist, Hist2D>::MultiplyVectorMatrix(const TVectorD &vector, const TMatrixD &matrix) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::printMatrix(const TMatrixD &matrix) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::printVector(const TVectorD &vector) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::SetMinInit(std::vector<Double_t> &init) const
{
   switch (_kernel) {
   ...
   case 1: {
      if (init.size() != 2) {
         std::cerr << init.size()
                   << " parameter initial values have been passed for the Marginal LH minimization. This should be 2 "
   ...
   case 2: {
      if (init.size() != 3) {
         std::cerr << init.size()
                   << " parameter initial values have been passed for the Marginal LH minimization. This should be 3 "
                      "for the Gibbs kernel.";
         return;
      }
      break;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::SetMinStep(std::vector<Double_t> &step) const
{
   switch (_kernel) {
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::MinimizeMLH() const
{
   ...
   // if (min->Status()){
   // std::cout << "Minimization of the marginal likelihood did not converge. Try again with new initial values and step
   // sizes." << std::endl; } else {
...
template <class Hist, class Hist2D>
Double_t RooUnfoldGPT<Hist, Hist2D>::MarginalLH(const double *params) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateK(const double *params) const
{

   switch (_kernel) {
   case 1: RadialKernel(params, _specialcache._truBinCenters, _specialcache._truBinCenters, _specialcache._K); break;
   case 2: GibbsKernel(params, _specialcache._truBinCenters, _specialcache._truBinCenters, _specialcache._K); break;
   default: std::cout << "Unknown kernel not available." << std::endl;
   }
}

template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateKstar(const double *params) const
{
   switch (_kernel) {
   case 1:
      RadialKernel(params, _specialcache._truBinCenters, _specialcache._obsBinCenters, _specialcache._Kstar);
      break;
   case 2: GibbsKernel(params, _specialcache._truBinCenters, _specialcache._truBinCenters, _specialcache._K); break;
   default: std::cout << "Unknown kernel not available." << std::endl;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateKstarstar(const double *params) const
{
   switch (_kernel) {
   case 1:
      RadialKernel(params, _specialcache._obsBinCenters, _specialcache._obsBinCenters, _specialcache._Kstarstar);
      break;
   case 2: GibbsKernel(params, _specialcache._truBinCenters, _specialcache._truBinCenters, _specialcache._K); break;
   default: std::cout << "Unknown kernel not available." << std::endl;
   }
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateK(const std::vector<Double_t> &params) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateKstar(const std::vector<Double_t> &params) const
{
   switch (_kernel) {
   case 1:
      RadialKernel(params, _specialcache._truBinCenters, _specialcache._obsBinCenters, _specialcache._Kstar);
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::EvaluateKstarstar(const std::vector<Double_t> &params) const
{
   switch (_kernel) {
   case 1:
      RadialKernel(params, _specialcache._obsBinCenters, _specialcache._obsBinCenters, _specialcache._Kstarstar);
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::RadialKernel(const double *params, const TVectorD &x, const TVectorD &xprime,
                                              TMatrixD &matrix) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::RadialKernel(const std::vector<Double_t> &params, const TVectorD &x,
                                              const TVectorD &xprime, TMatrixD &matrix) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::GibbsKernel(const double *params, const TVectorD &x, const TVectorD &xprime,
                                             TMatrixD &matrix) const
{
...
template <class Hist, class Hist2D>
void RooUnfoldGPT<Hist, Hist2D>::GibbsKernel(const std::vector<Double_t> &params, const TVectorD &x,
                                             const TVectorD &xprime, TMatrixD &matrix) const
{
