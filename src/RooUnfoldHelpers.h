...
template <class Hist>
Hist *clone(const Hist *hist);
template <class Hist>
Hist *asimovClone(const Hist *hist, bool correctDensity);
template <class Hist>
Hist *asimov1DClone(const Hist *hist, bool correctDensity, TVectorD &val, TVectorD &err);
template <class Hist>
...
template <class Hist>
int nBins(const Hist *hist, bool overflow = false);
template <class Hist>
int nBins(const Hist *hist, RooUnfolding::Dimension d, bool overflow = false);
template <class Hist>
int bin(const Hist *h, int i, bool overflow);
template <class Hist>
int bin(const Hist *h, int i, int j, bool overflow);
template <class Hist>
int bin(const Hist *h, int i, int j, int k, bool overflow);
template <class Hist>
double binCenter(const Hist *h, int i, RooUnfolding::Dimension d);
template <class Hist>
double binWidth(const Hist *h, int i, RooUnfolding::Dimension d);
template <class Hist>
double binHighEdge(const Hist *h, int i, RooUnfolding::Dimension d);
template <class Hist>
double binLowEdge(const Hist *h, int i, RooUnfolding::Dimension d);
template <class Hist>
void binXYZ(const Hist *tru, int i, int &jx, int &jy, int &jz);
template <class Hist>
double binError(const Hist *h, int i, bool overflow);
template <class Hist>
double binContent(const Hist *h, int i, bool overflow);
template <class Hist>
double binVolume(const Hist *h, int i, bool overflow);
template <class Hist>
double binError(const Hist *h, int i, int j, Bool_t overflow);
template <class Hist>
double binContent(const Hist *h, int i, int j, Bool_t overflow);
template <class Hist>
double binVolume(const Hist *h, int i, int j, Bool_t overflow);
template <class Hist>
TVectorD h2v(const Hist *h, bool overflow = false, bool correctDensity = false);
template <class Hist>
TVectorD h2ve(const Hist *h, bool overflow = false, bool correctDensity = false);
template <class Hist>
void h2v(const Hist *h, TVectorD &v, bool overflow = false, bool correctDensity = false);
template <class Hist>
void h2ve(const Hist *h, TVectorD &v, bool overflow = false, bool correctDensity = false);
template <class Hist>
const char *varname(const Hist *h, Dimension d);
template <class Hist>
void printHistogram(const Hist *h);
template <class Hist>
void printTable(std::ostream &o, const Hist *hTrainTrue, const Hist *hTrain, const Hist *hTrue, const Hist *hMeas,
                const Hist *hReco, Bool_t _overflow = kFALSE,
                RooUnfolding::ErrorTreatment withError = RooUnfolding::kDefault, Double_t chi_squ = -999.0);
template <class Hist, class V>
V subtract(const TVectorD &orig, const Hist *hist, bool overflow, bool correctDensity);

template <class Hist>
int findBin(const Hist *h, double x, RooUnfolding::Dimension d);
template <class Hist1D>
int findBin(const Hist1D *h, Double_t x);
template <class Hist2D>
int findBin(const Hist2D *h, Double_t x, Double_t y);
template <class Hist3D>
int findBin(const Hist3D *h, Double_t x, Double_t y, double_t z);

template <class Hist, class Hist2D>
void h2mNorm(const Hist2D *h, TMatrixD &m, const Hist *norm, bool overflow = false, bool correctDensity = false);
template <class Hist, class Hist2D>
void h2meNorm(const Hist2D *h, TMatrixD &m, const Hist *norm, bool overflow = false, bool correctDensity = false);
template <class Hist, class Hist2D>
TMatrixD h2mNorm(const Hist2D *h, const Hist *norm, bool overflow = false, bool correctDensity = false);
template <class Hist, class Hist2D>
TMatrixD h2meNorm(const Hist2D *h, const Hist *norm, bool overflow = false, bool correctDensity = false);

template <class Hist2D>
void h2m(const Hist2D *h, TMatrixD &m, bool overflow = false, bool correctDensity = false);
template <class Hist2D>
void h2me(const Hist2D *h, TMatrixD &m, bool overflow = false, bool correctDensity = false);
template <class Hist2D>
TMatrixD h2m(const Hist2D *h, bool overflow = false, bool correctDensity = false);
template <class Hist2D>
TMatrixD h2me(const Hist2D *h, bool overflow = false, bool correctDensity = false);
...
Hist2D *createHist(const TMatrixD &m, const TMatrixD &me, const char *name, const char *title,
                   const std::vector<Variable<AnyHist>> &x, bool overflow = false);
template <class Hist2D, class AnyHist>
Hist2D *createHist(const TMatrixD &m, const char *name, const char *title, const Variable<AnyHist> &x,
                   const Variable<AnyHist> &y, bool overflow = false);
template <class Hist2D, class AnyHist>
Hist2D *createHist(const TMatrixD &m, const TMatrixD &me, const char *name, const char *title,
                   const Variable<AnyHist> &x, const Variable<AnyHist> &y, bool overflow = false);
template <class Hist2D, class AnyHist>
Hist2D *createHist(const TMatrixD &m, const char *name, const char *title, const std::vector<Variable<AnyHist>> &x,
                   const std::vector<Variable<AnyHist>> &y, bool overflow = false);
template <class Hist2D, class AnyHist>
Hist2D *
createHist(const TMatrixD &m, const TMatrixD &me, const char *name, const char *title,
           const std::vector<Variable<AnyHist>> &x, const std::vector<Variable<AnyHist>> &y, bool overflow = false);
template <class Hist, class AnyHist>
Hist *createHist(const TVectorD &vec, const char *name, const char *title, const std::vector<Variable<AnyHist>> &x,
                 bool overflow = false);
template <class Hist, class AnyHist>
Hist *
createHist(const TVectorD &vec, const char *name, const char *title, const Variable<AnyHist> &x, bool overflow = false);
template <class Hist, class AnyHist>
Hist *createHist(const TVectorD &vec, const TVectorD &errvec, const char *name, const char *title,
                 const std::vector<Variable<AnyHist>> &x, bool overflow = false);
template <class Hist, class AnyHist>
Hist *createHist(const TVectorD &vec, const TVectorD &errvec, const char *name, const char *title,
                 const Variable<AnyHist> &x, bool overflow = false);

void printTable(std::ostream &o, const TVectorD &vTrainTrue, const TVectorD &vTrain, const TVectorD &vMeas,
                const TVectorD &vReco);
void printTable(std::ostream &o, int dim, int ntxb, int ntyb, const TVectorD &vTrainTrue, const TVectorD &vTrain,
                const TVectorD &vTrue, const TVectorD &vMeas, const TVectorD &vReco, ErrorTreatment withError,
                const TVectorD &eTrue, const TVectorD &eReco, double chi_squ = -999., bool overflow = false);
...
template <class Hist>
std::vector<RooUnfolding::Variable<Hist>> vars(const Hist *h);
