...
public:
   ...
   RooUnfoldTUnfoldT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas,
                     TUnfold::ERegMode reg = TUnfold::kRegModeDerivative, Bool_t handleFakes = false,
                     const char *name = 0, const char *title = 0);
   RooUnfoldTUnfoldT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas, Double_t tau,
                     TUnfold::ERegMode reg = TUnfold::kRegModeDerivative, Bool_t handleFakes = false,
                     const char *name = 0, const char *title = 0);
