...
TUnfoldIterativeEMV17::TUnfoldIterativeEMV17(void) {
   f_inputBins=0;
   f_outputBins=0;
   f_constInputBins=0;
   f_constOutputBins=0;
...
TUnfoldIterativeEMV17::TUnfoldIterativeEMV17
(const TH2 *hist_A, TUnfold::EHistMap histmap,
 const TUnfoldBinningV17 *outputBins,const TUnfoldBinningV17 *inputBins) {
   ...
   if(!inputBins) {
      f_inputBins=new TUnfoldBinningV17(*detAxis,0,0);
   ...
   if(!outputBins) {
      f_outputBins=new TUnfoldBinningV17(*genAxis,1,1);
...
void TUnfoldIterativeEMV17::DoUnfold(Int_t numIterations) {
...
Int_t TUnfoldIterativeEMV17::SetInput(const TH1 *hist_y,Double_t scaleBias) {
   int nRec=f_constInputBins->GetEndBin();
...
void TUnfoldIterativeEMV17::Reset(void) {
...
void TUnfoldIterativeEMV17::DoUnfold
(Int_t nIter,const TH1 *hist_y, Double_t scaleBias) {
   SetInput(hist_y,scaleBias);
   DoUnfold(nIter);
}

void TUnfoldIterativeEMV17::IterateOnce(void) {
...
Int_t TUnfoldIterativeEMV17::ScanSURE(Int_t nIterMax,TGraph **graphSURE,
                                      TGraph **df_deviance) {
   Reset();
   ...
   Info("TUnfoldIterativeEMV17::ScanSURE",
...
TH1 *TUnfoldIterativeEMV17::GetOutput
...
TH1 *TUnfoldIterativeEMV17::GetFoldedOutput
(const char *histogramName,const char *histogramTitle,
 const char *distributionName,const char *projectionMode,
...
Double_t TUnfoldIterativeEMV17::GetDeviance(void) const {
...
Double_t TUnfoldIterativeEMV17::GetDF(void) const {
   double r=0.;
...
Double_t TUnfoldIterativeEMV17::GetSURE(void) const {
