...
void TUnfoldSysV17::AddSysError
...
void TUnfoldSysV17::DoBackgroundSubtraction(void)
{
   // fY = fYData - fBgrIn
...
Int_t TUnfoldSysV17::SetInput(const TH1 *hist_y,Double_t scaleBias,
...
void TUnfoldSysV17::SubtractBackground
...
void TUnfoldSysV17::GetBackground
...
void TUnfoldSysV17::InitTUnfoldSys(void)
{
...
void TUnfoldSysV17::ClearResults(void)
{
...
void TUnfoldSysV17::PrepareSysError(void)
{
   // data members modified
...
/// 
void TUnfoldSysV17::GetEmatrixSysUncorr
...
TMatrixDSparse *TUnfoldSysV17::PrepareUncorrEmat
...
TMatrixDSparse *TUnfoldSysV17::PrepareCorrEmat
...
/// <br/>
/// the array <b>binMap</b> is explained with the method GetOutput(). 
Bool_t TUnfoldSysV17::GetDeltaSysSource(TH1 *hist_delta,const char *name,
                                   const Int_t *binMap)
{
   PrepareSysError();
...
Bool_t TUnfoldSysV17::GetDeltaSysBackgroundScale
...
Bool_t TUnfoldSysV17::GetDeltaSysTau(TH1 *hist_delta,const Int_t *binMap)
{
...
void TUnfoldSysV17::GetEmatrixSysSource
...
void TUnfoldSysV17::GetEmatrixSysBackgroundScale
(TH2 *ematrix,const char *name,const Int_t *binMap,Bool_t clearEmat)
{
   PrepareSysError();
...
void TUnfoldSysV17::GetEmatrixSysTau
(TH2 *ematrix,const Int_t *binMap,Bool_t clearEmat)
{
...
void TUnfoldSysV17::GetEmatrixInput
(TH2 *ematrix,const Int_t *binMap,Bool_t clearEmat)
{
...
void TUnfoldSysV17::GetEmatrixSysBackgroundUncorr
...
void TUnfoldSysV17::GetEmatrixFromVyy
...
///
/// the array <b>binMap</b> is explained with the method GetOutput(). 
void TUnfoldSysV17::GetEmatrixTotal(TH2 *ematrix,const Int_t *binMap)
{
...
TMatrixDSparse *TUnfoldSysV17::GetSummedErrorMatrixYY(void)
{
   PrepareSysError();
...
TMatrixDSparse *TUnfoldSysV17::GetSummedErrorMatrixXX(void)
{
   PrepareSysError();
...
/// <br/>
/// the array <b>binMap</b> is explained with the method GetOutput(). 
void TUnfoldSysV17::GetRhoItotal(TH1 *rhoi,const Int_t *binMap,TH2 *invEmat)
{
...
void TUnfoldSysV17::ScaleColumnsByVector
...
/// <br/>
/// The array <b>binMap</b> is explained with the method GetOutput()
void TUnfoldSysV17::VectorMapToHist
