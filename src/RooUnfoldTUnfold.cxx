...
account for bin migration and smearing <p>Errors come as a full covariance matrix. <p>Will sometimes warn of "unlinked"
bins. These are bins with  entries and do not effect the results of the unfolding <p>Regularisation parameter can be
either optimised internally by plotting log10(chi2 squared) against log10(tau). The 'kink' in this curve is deemed the
optimum tau value. This value can also be set manually (FixTau) <p>The latest version (TUnfold 15 in ROOT 2.27.04) will
not handle plots with an additional underflow bin. As a result overflows must be turned off if v15 of TUnfold is used.
ROOT versions 5.26 or below use v13 and so should be safe to use overflows.</ul>
 */
...
RooUnfolding::Algorithm RooUnfoldTUnfoldT<Hist, Hist2D>::GetAlgorithm() const
{
...
template <class Hist, class Hist2D>
RooUnfoldTUnfoldT<Hist, Hist2D>::RooUnfoldTUnfoldT(const RooUnfoldTUnfoldT &rhs) : RooUnfoldT<Hist, Hist2D>(rhs)
{
   // Copy constructor.
   Init();
   CopyData(rhs);
...
template <class Hist, class Hist2D>
RooUnfoldTUnfoldT<Hist, Hist2D>::RooUnfoldTUnfoldT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas,
                                                   TUnfold::ERegMode reg, Bool_t handleFakes, const char *name,
                                                   const char *title)
...
template <class Hist, class Hist2D>
RooUnfoldTUnfoldT<Hist, Hist2D>::RooUnfoldTUnfoldT(const RooUnfoldResponseT<Hist, Hist2D> *res, const Hist *meas,
                                                   Double_t tau, TUnfold::ERegMode reg, Bool_t handleFakes,
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::Destroy()
{
   delete _unf;
   delete _lCurve;
   delete _logTauX;
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::Reset()
{
   // Resets all values
   Destroy();
   Init();
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::Assign(const RooUnfoldTUnfoldT &rhs)
{
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::CopyData(const RooUnfoldTUnfoldT &rhs)
{
   tau_set = rhs.tau_set;
   _tau = rhs._tau;
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::Init()
{
   tau_set = false;
   _tau = -1e30;
   _unf = 0;
...
template <class Hist, class Hist2D>
TUnfold *RooUnfoldTUnfoldT<Hist, Hist2D>::Impl()
{
...
template <class Hist, class Hist2D>
const TGraph *RooUnfoldTUnfoldT<Hist, Hist2D>::GetLCurve() const
{
...
template <class Hist, class Hist2D>
const TSpline *RooUnfoldTUnfoldT<Hist, Hist2D>::GetLogTauX() const
{
   // If an L curve scan has been done (tau not fixed by user),
...
template <class Hist, class Hist2D>
const TSpline *RooUnfoldTUnfoldT<Hist, Hist2D>::GetLogTauY() const
{
   // If an L curve scan has been done (tau not fixed by user),
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::Unfold() const
{
   ...
   if (CheckEmptyRowsAndColumns(this->response()->Mresponse(false))) {
      throw std::runtime_error(
         "TUnfold cannot deal with empty rows or columns in the response matrix, please reduce your histogram range!");
   }

   // Does the unfolding. Uses the optimal value of the unfolding parameter unless a value has already been set using
   // FixTau
   if (nm < nt)
      std::cerr << "Warning: fewer measured bins than truth bins. TUnfold may not work correctly." << std::endl;
   if (this->_covMes)
      std::cerr << "Warning: TUnfold does not account for bin-bin correlations on measured input" << std::endl;
   ...
   if (ndim == 2 || ndim == 3)
      reg = TUnfold::kRegModeNone; // set explicitly
   ...
   ROOT_VERSION(5, 23, 0) /* TUnfold v6 (included in ROOT 5.22) didn't have setInput return value */
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::GetCov() const
{
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::FixTau(Double_t tau)
{
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::SetRegMethod(TUnfold::ERegMode regmethod)
{
   /*
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::OptimiseTau()
{
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::GetSettings() const
{
...
template <class Hist, class Hist2D>
RooUnfoldTUnfoldT<Hist, Hist2D>::RooUnfoldTUnfoldT() : RooUnfoldT<Hist, Hist2D>()
{
...
template <class Hist, class Hist2D>
RooUnfoldTUnfoldT<Hist, Hist2D> &RooUnfoldTUnfoldT<Hist, Hist2D>::operator=(const RooUnfoldTUnfoldT<Hist, Hist2D> &rhs)
{
...
template <class Hist, class Hist2D>
void RooUnfoldTUnfoldT<Hist, Hist2D>::SetRegParm(Double_t parm)
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldTUnfoldT<Hist, Hist2D>::GetTau() const
{
...
template <class Hist, class Hist2D>
Double_t RooUnfoldTUnfoldT<Hist, Hist2D>::GetRegParm() const
{
   // Return regularisation parameter (tau)
   return _tau;
}
...
template <class Hist, class Hist2D>
TUnfold::ERegMode RooUnfoldTUnfoldT<Hist, Hist2D>::GetRegMethod() const
{
   return _reg_method;
}
