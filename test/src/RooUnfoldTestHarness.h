...
public:
   ...
   virtual TH1D *Generate(TVectorD &x, const char *name, const char *title, Int_t nt, Int_t fpdf, Int_t nx,
                          Double_t xlo, Double_t xhi, Double_t bkg, Double_t mean, Double_t width, Double_t bias,
                          Double_t smear);
   virtual Int_t
   Fakes(TVectorD &x, Int_t nm, Int_t nx, Double_t lo, Double_t hi, Double_t fakelo, Double_t fakehi) const;
   ...
   static void setmax(TH1 *h, const TH1 *h1 = 0, const TH1 *h2 = 0, const TH1 *h3 = 0, const TH1 *h4 = 0,
                      const TH1 *h5 = 0, const TH1 *h6 = 0);
   static void
   Legend(TLegend *&legend, TH1 *pdf, TH1 *truth, TH1 *fake, TH1 *meas, TH1 *unfold = 0, TF1 *ff = 0, TF1 *tf = 0);
   static TH2D *CorrelationHist(const TMatrixD &cov, const char *name = "rho", const char *title = "Correlation matrix",
